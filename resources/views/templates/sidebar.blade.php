...
<aside class="main-sidebar sidebar-dark-danger elevation-4">
    ...
    <a href="index3.html" class="brand-link bg-danger">
        <img src="{{ asset('public/adminlte/dist/img/LOGOX.svg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('laboratorium') }}" class="nav-link @if($menu == 'Laboratorium' ) active @endif">
                        <i class="nav-icon fas fa-archive"></i>
                        <p>
                            Laboratorium
                        </p>
